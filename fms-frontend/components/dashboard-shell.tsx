          ...
          <div className="@container/main flex flex-1 flex-col">
            ...
            >
              <div className="flex flex-col gap-0">
                <div className="flex flex-row items-center justify-between gap-4 border border-b-0 border-white/8 bg-card bg-noise shadow-[0_1px_0_rgba(255,255,255,0.03)] px-4 py-8 ">
